...
const categorias = [{ label: "Relleno azul, borde verde", stroke: [0, 255, 0], fill: [0, 0, 255] },
{ label: "Relleno rojo, borde negro", stroke: [0, 0, 0], fill: [255, 0, 0] },
    ...
    knn.classify(Imagen, function(error, result) {
      if (error) {
        ...
        if (!CargandoNeurona) {
          ...
          CartaMensaje.innerText = Etiqueta + " con " + Confianza + "% de confianza";
      }
    });
  }
}
